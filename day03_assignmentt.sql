/*
 * 1 (1)원자성 (2)완전 함수적 종속 (3)이행적 종속 제거
 * 2 (1)제3정규화(3NF) (2)제2정규화(2NF)
 * 3 (1)inner join (2)left join (3)right join (4)outer join
 * 4 (1)반정규화(Denormalization)
 * 5 (1)인덱스(Index) (2)인덱스 (3)인덱스 (4)인덱스
 * 6 (1)트랜잭션(Transaction) (2)Atomicity(원자성) (3)Consistency(일관성) 
 * 
 */
